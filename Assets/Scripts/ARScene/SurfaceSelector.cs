...
public class SurfaceSelector : MonoBehaviour
{
    ...
    public void PlaceMarkerOnSerface(){
        ...
        if(hit.Trackable is DetectedPlane){
            ...
            //     GameObject point = placementIndicator.PlaceObjectAtPlacementPoseWithReturn(verticalMarker, hit);
            //     verticlePoints.Add(point);
            //     VisualizeLine(point, verticlePoints);
            // }
        }
    }
